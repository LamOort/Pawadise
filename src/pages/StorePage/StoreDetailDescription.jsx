      ...
      <div className="store__description">
        <div className="store__description--general">
          <div className="store__description--general--left">
            <p className="store__description--attribute">SĐT</p>

            <p className="store__description--attribute">Giờ mở cửa</p>

            <p className="store__description--attribute">Đánh giá</p>
          </div>

          <div className="store__description--general--right">
            <p className="store__description--value">{info.phoneNumber}</p>

            <p className="store__description--value">{info.openTime}</p>

            <p className="store__description--value">5/5</p>
          </div>
        </div>
